...
void W25xx_PageRead(u32 address, u8* p, u32 number)
{
    ...
    for(i = 0; i < 256; i++) {
        SPIRxData[i] = W25xx_ReadWriteByte(0x00);
    }
    W25xx_CS_High();
}
...
/// @note   None.
/// @param  spi_baud_div: Baudrate prescaler.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Enable internal NSS pins for selected SPI software
/// @note   None.
/// @param  None.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief  Release internal NSS pins for selected SPI software
/// @note   None.
/// @param  None.
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
...
void SPI_FlashTest(void)
{
    ...
    W25xx_ReadID();
    W25xx_SectorErase(0);
    W25xx_PageProgram(0, SPITxData, 256);
    for(i = 0; i < 256; i++) {
        SPIRxData[i] = 0x0;
    }
    W25xx_PageRead(0, SPIRxData, 256);
    for(i = 0; i < 10; i++) {
        printf("rx[%d]=0x%x\r\n", i, SPIRxData[i]);
    }
